...
Module GestioneErrori
    ...
    ''' <remarks></remarks>
    Public Function TrapError(exception As Exception, sNomeProcedura As String) As String
        ...
        '
        ' Scrivo il messaggio di errore nel trace
        '
        Trace.TraceError("Di.PortalUser.PrintDispatcher - Errore: " & FormatException(exception))
        '
        'Gestisco l'errore su application insights
        '
        Dim dicProp As New Dictionary(Of String, String)
        dicProp.Add("NomePortale", "PrintDispatcher-User")
        dicProp.Add("NomeProcedura", sNomeProcedura)
