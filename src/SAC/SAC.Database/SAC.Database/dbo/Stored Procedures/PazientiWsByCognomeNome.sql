...
-- =============================================
CREATE PROCEDURE dbo.PazientiWsByCognomeNome
(
	@Identity varchar(64),
	@Cognome varchar(64),
	@Nome varchar(64)
...
BEGIN
	...
	BEGIN
		EXEC PazientiEventiAccessoNegato @Identity, 0, 'PazientiWsByCognomeNome', 'Utente non ha i permessi di lettura!'

		RAISERROR('Errore di controllo accessi durante PazientiWsByCognomeNome!', 16, 1)
		RETURN
	END
	--
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PazientiWsByCognomeNome] TO [DataAccessWs]
    AS [dbo];
