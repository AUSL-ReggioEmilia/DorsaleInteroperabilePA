...
CREATE PROCEDURE [Progel].[CreaSP_1_6] 
(
...
BEGIN
	...
	***********************/
	...
	BEGIN
		...
		***********************/ 
		PRINT @CRLF
		PRINT @CRLF
		PRINT 'ALTER PROCEDURE [' + @SCHEMA + '].[' + @PROCNAME + 'Inserisce]' 
		...
		***********************/ 	
		...
		PRINT @CRLF
		PRINT @CRLF
		PRINT 'ALTER PROCEDURE [' + @SCHEMA + '].[' + @PROCNAME + 'Modifica]' 
		PRINT '('
		...
		***********************/ 
		...
		PRINT @CRLF
		PRINT @CRLF
		PRINT 'ALTER PROCEDURE [' + @SCHEMA + '].[' + @PROCNAME + 'Rimuove]' 
		PRINT '('
		...
		***********************/ 
		PRINT @CRLF
		PRINT @CRLF
		PRINT 'ALTER PROCEDURE [' + @SCHEMA + '].[' + @PROCNAME + 'Ottieni]' 
		PRINT '('
		PRINT @PARAM_KEY
		PRINT ')'
		PRINT 'AS'
	...
	***********************/ 	
	...
	BEGIN
		PRINT @CRLF
		PRINT @CRLF
		PRINT 'ALTER PROCEDURE [' + @SCHEMA + '].[' + @PROCNAME + 'Cerca]' 
		PRINT '('
	...
	***********************/ 	
	...
	BEGIN
		...
		PRINT @CRLF
		PRINT @CRLF
		PRINT 'ALTER PROCEDURE [' + @SCHEMA + '].[' + @PROCNAME + 'OttieniPer' + @FKNAME + ']'
		PRINT '('
		PRINT ' @' + @FKNAME + ' ' + @FKTYPE + 
				CASE @FKTYPE 
