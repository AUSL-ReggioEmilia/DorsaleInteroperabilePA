...
Public Class TranscodificaPrioritaLista
...
#Region "Property di pagina"
    ...
    Private Const PAGE_DETAIL As String = "~/Transcodifiche/TranscodificaPrioritaDettaglio.aspx"

#End Region

    Private Sub TranscodificaPrioritaLista_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            '
...
#Region "ObjectDataSource"
    Private Sub odsTranscodificaPriorita_Selected(sender As Object, e As ObjectDataSourceStatusEventArgs) Handles odsTranscodificaPriorita.Selected
        '
    ...
    Private Sub odsTranscodificaPriorita_Selecting(sender As Object, e As ObjectDataSourceSelectingEventArgs) Handles odsTranscodificaPriorita.Selecting
        Try
            '
    ...
    Private Sub SearchButton_Click(sender As Object, e As EventArgs) Handles SearchButton.Click
        Try
            ...
            If ValidateFilters() Then
                ...
                '
                gvTranscodificaPriorita.DataBind()
            End If
        Catch ex As Exception
            Dim sMessage As String = Utility.TrapError(ex, True)
            Utility.ShowErrorLabel(lblError, sMessage)
...
#Region "Eventi_GridView"
    Private Sub gvTranscodificaPriorita_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvTranscodificaPriorita.RowCommand
        Try
            '
            ...
            Dim gID As Guid = gvTranscodificaPriorita.DataKeys(rowIndex).Values("Id")

            If e.CommandName.ToUpper = "CANCELLA" Then
                '
                ' Eseguo SP di rimozione
                '
                Using ta As New TranscodificheDataSetTableAdapters.TranscodificaPrioritaOttieniTableAdapter
                    ta.Delete(gID)
                End Using
                '
