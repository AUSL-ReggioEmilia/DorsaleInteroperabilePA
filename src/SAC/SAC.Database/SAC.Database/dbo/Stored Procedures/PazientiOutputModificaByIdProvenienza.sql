...
CREATE PROCEDURE [dbo].[PazientiOutputModificaByIdProvenienza]
(
...
*/
	...
	BEGIN
		EXEC dbo.PazientiEventiAccessoNegato @Identity, 0, 'PazientiOutputModificaByIdProvenienza', 'Utente non ha i permessi di scrittura!'
		RAISERROR('Errore di controllo accessi durante PazientiOutputModificaByIdProvenienza!', 16, 1)
		RETURN
	END
	--
	...
	BEGIN
		RAISERROR('Errore di Provenienza non trovata durante PazientiOutputModificaByIdProvenienza!', 16, 1)
		RETURN
	END
	---------------------------------------------------
	-- MODIFICA ETTORE 2014-04-25:
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PazientiOutputModificaByIdProvenienza] TO [DataAccessSql]
    AS [dbo];
