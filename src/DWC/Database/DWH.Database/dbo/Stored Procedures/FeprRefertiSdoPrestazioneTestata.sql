...
CREATE PROCEDURE [dbo].[FeprRefertiSdoPrestazioneTestata]
(
...
/*
	...
	Uso le nuove funzioni GetRefertiAttributo2() con data di partizione
*/
	SET NOCOUNT ON
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[FeprRefertiSdoPrestazioneTestata] TO [ExecuteFrontEnd]
    AS [dbo];
