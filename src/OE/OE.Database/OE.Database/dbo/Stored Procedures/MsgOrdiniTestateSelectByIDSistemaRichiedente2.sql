...
-- Description:	Seleziona una testata ordine by id sistema richiedente con anche i dati dei sistemi e UO
-- =============================================
CREATE PROCEDURE [dbo].[MsgOrdiniTestateSelectByIDSistemaRichiedente2]
...
--Modificata: SANDRO 2014-01-27 Nuovi campi ritornati (SistemaRichiedente, UnitaOperativaRichiedente)
--Modificata: SANDRO 2014-09-24 Nuovi campi ritornati (AnteprimaPrestazioni)
	...
	BEGIN TRY
		...
		WHERE IDSistemaRichiedente = @IDSistemaRichiedente
			AND IDRichiestaRichiedente = @IDRichiestaRichiedente
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MsgOrdiniTestateSelectByIDSistemaRichiedente2] TO [DataAccessMsg]
    AS [dbo];
