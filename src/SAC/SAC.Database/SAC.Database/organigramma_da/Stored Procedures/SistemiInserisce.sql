...
-- Description:	Inserisce un sistema e ritorna l'inserito
-- =============================================
CREATE PROC [organigramma_da].[SistemiInserisce]
(
 @Codice varchar(16),
...
BEGIN
	...
	BEGIN
		EXEC [organigramma].[EventiAccessoNegato] NULL, 0, '[organigramma_da].[SistemiInserisce]', 'Utente non ha i permessi di lettura!'

		RAISERROR('Errore di controllo accessi durante [organigramma_da].[SistemiInserisce]!', 16, 1)
		RETURN
	END
	...
	BEGIN CATCH
		...
		EXEC [organigramma].[EventiErrore] NULL, @ErrorLogId, '[organigramma_da].[SistemiInserisce]', 'Vedi la tabella ErrorLog!'
