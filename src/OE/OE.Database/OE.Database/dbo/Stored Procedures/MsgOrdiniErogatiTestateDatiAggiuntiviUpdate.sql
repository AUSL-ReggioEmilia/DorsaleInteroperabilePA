...
-- =============================================
CREATE PROCEDURE [dbo].[MsgOrdiniErogatiTestateDatiAggiuntiviUpdate]
	  @ID uniqueidentifier
...
BEGIN
	...
	BEGIN TRY
		...
		-- UPDATE
		------------------------------		
		UPDATE OrdiniErogatiTestateDatiAggiuntivi
			SET
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MsgOrdiniErogatiTestateDatiAggiuntiviUpdate] TO [DataAccessMsg]
    AS [dbo];
