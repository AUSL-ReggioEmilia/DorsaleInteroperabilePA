<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RefertiInviiSoleSinottico.aspx.vb" Inherits=".RefertiInviiSoleSinottico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <%-- GRIGLIA --%>
    <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" AllowSorting="false" CssClass="Grid" EnableModelValidation="True" EmptyDataText="Nessun risultato!" DataSourceID="odsLista">
        <Columns>
    ...
    <asp:ObjectDataSource ID="odsLista" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="DI.DataWarehouse.Admin.Data.SoleTableAdapters.RefertiInviiSoleSinotticoTableAdapter">
        <SelectParameters>
