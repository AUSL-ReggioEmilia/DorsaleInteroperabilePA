<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="SistemaRuoloLista.aspx.vb" Inherits=".SistemaRuoloListaaspx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" DataKeyNames="ID,IDRuolo,IdSistema" DataSourceID="odsRuoli"       
        ...
        <Columns>
            ...
            <%--<asp:BoundField DataField="IDRuolo" HeaderText="IDRuolo" ReadOnly="false" SortExpression="IDRuolo"></asp:BoundField>--%>
    ...
    <asp:ObjectDataSource ID="odsRuoli" runat="server" CacheDuration="120" CacheKeyDependency="CacheRuoloSistemi" DeleteMethod="Delete"
		EnableCaching="True" InsertMethod="Insert" OldValuesParameterFormatString="{0}" SelectMethod="GetData" TypeName="OrganigrammaDataSetTableAdapters.RuoliCercaPerSistemaTableAdapter">
        <InsertParameters>
        ...
        <SelectParameters>
            <asp:QueryStringParameter DbType="Guid" Name="IdSistema" QueryStringField="IdSistema" />
