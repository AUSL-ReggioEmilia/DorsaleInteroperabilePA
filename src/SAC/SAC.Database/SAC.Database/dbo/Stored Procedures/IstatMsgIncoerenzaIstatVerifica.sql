...
BEGIN
/*
	ATTENZIONE: La SP viene chiamata dalla DAE e si aspetta i codici comune già normalizzati
	...
	Codici di errore:
		...
		5003 comune recapito non valido	-- NON USATO PER ORA
*/
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[IstatMsgIncoerenzaIstatVerifica] TO [DataAccessDll]
    AS [dbo];
