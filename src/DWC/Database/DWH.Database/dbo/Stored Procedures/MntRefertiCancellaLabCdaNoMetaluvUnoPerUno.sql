...
-- =============================================
CREATE PROCEDURE [dbo].[MntRefertiCancellaLabCdaNoMetaluvUnoPerUno]
...
DECLARE @StatoRefertoCodice tinyint
	...
	WHERE rb.SistemaErogante = 'LABCDA'
		AND rb.RepartoErogante <> 'METALUV'
	...
	PRINT 'Trovati ' + ISNULL(CONVERT(VARCHAR(10), @Trovati), '0') + ' referti LABCDA no METALUV!'
