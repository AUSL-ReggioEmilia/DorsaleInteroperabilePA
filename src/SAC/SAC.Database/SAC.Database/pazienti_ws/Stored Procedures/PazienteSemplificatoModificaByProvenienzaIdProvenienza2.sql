...
-- Description:	Aggiorna UN SOTTOINSIEME di campi della tabella Pazienti per Provenienza, IdProvenienza
--				ETTORE: Riattivazione anagrafiche cancellate logicamente [ASMN-4052]
--				Chiama la pazienti_ws.PazienteSemplificatoModificaBase
-- =============================================
CREATE PROCEDURE [pazienti_ws].[PazienteSemplificatoModificaByProvenienzaIdProvenienza2]
(
