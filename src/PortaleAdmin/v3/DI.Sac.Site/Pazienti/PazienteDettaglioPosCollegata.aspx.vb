...
Public Class PazienteDettaglioPosCollegata
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            End If
            '
            ' Memorizzo l'id paziente originale (lo faccio sempre)
            '
            ...
            If Not IsPostBack Then
                ...
                '
                ' Verifico i diritti utente: testo solo il diritto di creazione poichè a questa pagina si arriva solo dopo avere creato una "posizione collegata"
                '
