...
Public Class RuoloSistemiLista
	...
	Private Sub Page_PreInit(sender As Object, e As System.EventArgs) Handles Me.PreInit
		...
		If Not Page.IsPostBack Then
			...
			Cache.Remove("CacheRuoloSistemi")
		End If
    ...
    Private Sub Page_PreRenderComplete(sender As Object, e As System.EventArgs) Handles Me.PreRenderComplete
		Try
			...
			If mbModalitàInserimento Then
				lblTitolo.Text = "Associazione dei Sistemi al Ruolo: " & ViewState(KEY_DESCRUOLO)
			Else
				lblTitolo.Text = "Sistemi associati al Ruolo: " & ViewState(KEY_DESCRUOLO)
			End If
	...
	Private Sub odsLista_Selecting(sender As Object, e As ObjectDataSourceSelectingEventArgs) Handles odsLista.Selecting
        Try
            ...
            End If
            '
            ' MODIFICA ETTORE 2017-03-27: Passo il valore al parametro @Attivo (BOOLEAN NULLABILE) della query 
            '
        ...
        Try
            For Each row As GridViewRow In gvLista.Rows
                ...
                If chkItem.Checked Then
                    ...
                    odsLista.InsertParameters("IdSistema").DefaultValue = gvLista.DataKeys(row.RowIndex).Values("IdSistema").ToString
                    odsLista.Insert()
                    iNumChecked += 1
                End If
            Next
