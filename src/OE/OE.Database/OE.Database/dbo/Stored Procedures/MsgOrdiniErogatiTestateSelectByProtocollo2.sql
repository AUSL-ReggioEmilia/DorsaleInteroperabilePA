...
--
-- Description:	Seleziona una testata ordine erogato per anno numero richiesta con dati sistemi
-- =============================================
CREATE PROCEDURE [dbo].[MsgOrdiniErogatiTestateSelectByProtocollo2]
(
 @Anno int
,@Numero int
)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MsgOrdiniErogatiTestateSelectByProtocollo2] TO [DataAccessMsg]
    AS [dbo];
