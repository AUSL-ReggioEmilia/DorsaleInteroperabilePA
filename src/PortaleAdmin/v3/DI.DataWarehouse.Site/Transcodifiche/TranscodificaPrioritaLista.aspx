<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TranscodificaPrioritaLista.aspx.vb" Inherits=".TranscodificaPrioritaLista" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <%-- TABELLA Priorita --%>
    <asp:GridView ID="gvTranscodificaPriorita" runat="server" DataSourceID="odsTranscodificaPriorita" AllowPaging="True" AllowSorting="True" CssClass="Grid" AutoGenerateColumns="False" DataKeyNames="Id" PageSize="100" PagerSettings-Position="TopAndBottom">
        ...
        <Columns>
            ...
            <asp:HyperLinkField runat="server" Text="&lt;img src='../Images/detail.png' alt='Vai al dettaglio...' /&gt;" DataNavigateUrlFormatString="TranscodificaPrioritaDettaglio.aspx?Id={0}"
    ...
    <asp:ObjectDataSource ID="odsTranscodificaPriorita" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetData" TypeName="TranscodificheDataSetTableAdapters.TranscodificaPrioritaCercaTableAdapter">
        <SelectParameters>
