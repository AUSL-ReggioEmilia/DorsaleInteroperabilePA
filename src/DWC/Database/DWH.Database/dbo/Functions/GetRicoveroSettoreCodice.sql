...
-- Author:		ETTORE
-- Create date: ???
-- MODIFICA ETTORE 2015-03-02: modificata per utilizzare la vista dbo.EventiBase 
...
-- Description:	
-- =============================================
CREATE FUNCTION [dbo].[GetRicoveroSettoreCodice]
(
	...
	FROM 
		...
		inner join store.EventiAttributi 
			on Eventi.Id = EventiAttributi.IdEventiBase 
				AND EventiAttributi.Nome = 'SettoreCodice'
	WHERE 
