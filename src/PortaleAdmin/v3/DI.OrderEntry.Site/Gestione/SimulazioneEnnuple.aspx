<%@ Page Title="Order Entry - Simulazione Ennuple" Language="vb" AutoEventWireup="false"
	MasterPageFile="~/OrderEntry.Master" CodeBehind="SimulazioneEnnuple.aspx.vb"
	Inherits="DI.OrderEntry.Admin.SimulazioneEnnuple" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="OrderEntryContentPlaceHolder" runat="server">
	...
	<div id="filterPanel" runat="server" style="width: 100%;">
		<fieldset style="width: 100%;">
			...
			<table style="width: 100%; border-collapse: collapse;">
				...
				<tr>
					<td colspan="2" style="vertical-align: top; padding-top: 22px;">Filtri esclusivi delle prestazioni restituite
					</td>
	...
	<div id="EnnupleInteressate" runat="server">
		...
		<div style="padding: 0px 0px 10px 15px">
			...
			<asp:ObjectDataSource ID="EnnupleInteressateObjectDataSource" runat="server" SelectMethod="GetData"
				TypeName="DI.OrderEntry.Admin.Data.EnnupleTableAdapters.UiSimulazioneEnnupleInteressateListTableAdapter"
	...
	<asp:GridView ID="SimulazioneEnnupleGridView" runat="server" DataSourceID="SimulazioneEnnupleObjectDataSource"
		...
		<Columns>
			...
			<asp:BoundField DataField="Descrizione" HeaderText="Descrizione" SortExpression="Descrizione" HeaderStyle-Width="30%"/>
			<%--<asp:BoundField DataField="IDSistemaErogante" HeaderText="IDSistemaErogante" SortExpression="IDSistemaErogante" />--%>
			<asp:CheckBoxField DataField="Attivo" HeaderText="Attivo" SortExpression="Attivo" HeaderStyle-Width="30%" />
		</Columns>
	</asp:GridView>

	<asp:ObjectDataSource ID="SimulazioneEnnupleObjectDataSource" runat="server" SelectMethod="GetData"
		TypeName="DI.OrderEntry.Admin.Data.EnnupleTableAdapters.UiSimulazioneEnnupleListTableAdapter"
		OldValuesParameterFormatString="original_{0}">
		<SelectParameters>
			<asp:ControlParameter ControlID="UtenteFiltroTextBox" Name="nomeUtente" PropertyName="Text" Type="String" />
			<asp:ControlParameter ControlID="DataFiltroTextBox" Name="giorno" PropertyName="Text" Type="DateTime" />
			...
			<asp:ControlParameter ControlID="CodiceDescrizioneFiltroTextBox" Name="prestazioneCodiceDescrizione" PropertyName="Text" Type="String" />
	...
	<script src="../Scripts/simulazione-ennuple.js?<%= ScriptUtility.Ticks %>" type="text/javascript"></script>
</asp:Content>
