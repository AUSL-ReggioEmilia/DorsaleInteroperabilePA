...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="jumbotron jumbotron-toolbar-custom-margin">
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        <asp:LinkButton runat="server" ID="BtnPianifica" Text="Prenota" class="btn btn-sm btn-primary" OnClick="BtnPianifica_Click" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <ContentTemplate>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body small" runat="server">
                            <asp:FormView ID="fvInfoPaziente" runat="server" DataSourceID="odsPaziente" RenderOuterTable="false" ItemType="OrderEntryPlanner.WcfPazienti.PazienteType">
                                <ItemTemplate>
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <h4>
            ...
            <div class="row" id="divTestataOrdine" runat="server">
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body small " runat="server">
                            <asp:FormView ID="fvTestataOrdine" runat="server" RenderOuterTable="False" DataSourceID="odsTestataOrdine" DataKeyNames="Id,Richiesta">
                                <ItemTemplate>
                                    <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <label class="label2 control-label" style="font-weight: normal">
                                                            <%# Eval("DataPrenotazione", "{0:dd/MM/yyyy HH:mm}") %>&nbsp;
                                                            <asp:LinkButton ID="LinkButton1" runat="server" Text="Prenota" CssClass="btn-sm btn-primary" Style="text-decoration: none"
                                                                OnClick="btnRipianifica_Click"/>
                                                        </label>
                                                    </div>
                                                </div>
            ...
            <div class="row" id="divPrestazioni" runat="server">
                <div class="col-sm-12">
                    <span class='label label-default' style="float:left">Prestazioni</span>
                    <asp:GridView ID="gvPrestazioni" OnPreRender="gvPrestazioni_PreRender" ClientIDMode="Static" AutoGenerateColumns="False"
                        ...
                        DataSourceID="odsPrestazioni" Visible="true" DataKeyNames="Id,RigaRichiesta">
                        <Columns>
                            ...
                            <%-- Campo non popolato ed inute a livello di riga. C'è già in testata --%>
    ...
    <asp:ObjectDataSource ID="odsPaziente" OnSelecting="odsPaziente_Selecting" OnSelected="odsPaziente_Selected" runat="server" OldValuesParameterFormatString="{0}" SelectMethod="GetDataById" TypeName="OrderEntryPlanner.Components.DataSources.PazienteDettaglioDataSource">
        <SelectParameters>
