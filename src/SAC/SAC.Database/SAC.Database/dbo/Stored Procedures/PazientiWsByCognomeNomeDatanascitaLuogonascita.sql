...
-- =============================================
CREATE PROCEDURE dbo.PazientiWsByCognomeNomeDatanascitaLuogonascita
(
	@Identity varchar(64),
	@Cognome varchar(64),
	@Nome varchar(64),
...
BEGIN
	...
	BEGIN
		EXEC PazientiEventiAccessoNegato @Identity, 0, 'PazientiWsByCognomeNomeDatanascitaLuogonascita', 'Utente non ha i permessi di lettura!'

		RAISERROR('Errore di controllo accessi durante PazientiWsByCognomeNomeDatanascitaLuogonascita!', 16, 1)
		RETURN
	END
	--
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PazientiWsByCognomeNomeDatanascitaLuogonascita] TO [DataAccessWs]
    AS [dbo];
