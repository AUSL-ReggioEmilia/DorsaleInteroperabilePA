...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                '
                IframeMain.Src = String.Format("~/FSE/DocumentoViewer.aspx?CodiceDocumento={0}&CodiceFiscalePaziente={1}&CodiceFiscaleMedico={2}&TipoAccesso={3}&TipoDocumento={4}&NaturaDocumento={5}&Token={6}", Me.CodiceDocumento, Me.CodiceFiscalePaziente, Me.CodiceFiscaleMedico, Me.TipoAccesso, Me.TipoDocumento, Me.NaturaDocumento, Me.Token)
                IframeMain.DataBind()
    ...
    Private Sub BtnIndietro_Click(sender As Object, e As EventArgs) Handles BtnIndietro.Click
        Try
            ...
            '
            Response.Redirect("~/FSE/DocumentiLista.aspx?IdPaziente=" & Me.IdPaziente.ToString, False)
        Catch ex As Exception
            divErrorMessage.Visible = True
