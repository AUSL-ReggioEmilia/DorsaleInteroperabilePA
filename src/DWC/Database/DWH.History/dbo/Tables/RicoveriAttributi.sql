CREATE TABLE [dbo].[RicoveriAttributi] (
    ...
    CONSTRAINT [PK_RicoveriAttributi] PRIMARY KEY CLUSTERED ([DataPartizione] ASC, [IdRicoveriBase] ASC, [Nome] ASC) WITH (FILLFACTOR = 95, DATA_COMPRESSION = PAGE),
...
CREATE UNIQUE NONCLUSTERED INDEX [IXU_IdRicoveriBase_Nome]
    ON [dbo].[RicoveriAttributi]([IdRicoveriBase] ASC, [Nome] ASC) WITH (FILLFACTOR = 95);
