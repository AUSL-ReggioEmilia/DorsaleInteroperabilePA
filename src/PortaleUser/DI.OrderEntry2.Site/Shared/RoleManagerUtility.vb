...
Public Class RoleManagerUtility
    ...
    Public Const ATTRIB_OE_RICERCA_PER_ANAGRAFICA_SAC_ABILITATA As String = "ATTRIB@OE_RICERCA_PER_ANAGRAFICA_SAC_ABILITATA"
    Public Const ATTRIB_OE_RICERCA_PER_NOSOLOGICO_ABILITATA As String = "ATTRIB@OE_RICERCA_PER_NOSOLOGICO_ABILITATA"
    Public Const ATTRIB_OE_RICERCA_RICOVERATI_ABILITATA As String = "ATTRIB@OE_RICERCA_RICOVERATI_ABILITATA"
    ...
    Public Sub InitializeUser()
        ...
        Dim oPortalDataAdapterManager = New Data.PortalDataAdapterManager(msPortalUserConnectionString)
        Try
            t0 = Now()
