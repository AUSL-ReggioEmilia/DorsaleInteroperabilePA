...
-- =============================================
CREATE PROCEDURE [dbo].[PazientiWsModifica3]
(
	  @Identity varchar(64)
...
BEGIN
	...
	SET @Id = NULL --Lo imposto a NULL poichè non viene usato nell'aggiornamento per Provenienza e IdProvenienza
	...
	BEGIN
		EXEC dbo.PazientiEventiAccessoNegato @Identity, 0, 'PazientiWsModifica3', 'Utente non ha i permessi di scrittura!'

		RAISERROR('Errore di controllo accessi durante PazientiWsModifica3!', 16, 1)
		RETURN
	END
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PazientiWsModifica3] TO [DataAccessWs]
    AS [dbo];
