...
-- =============================================
CREATE PROCEDURE [dbo].[MsgOrdiniRigheErogateDatiAggiuntiviUpdate]
	  @ID uniqueidentifier
...
BEGIN
	...
	BEGIN TRY
		...
		-- UPDATE
		------------------------------		
		UPDATE OrdiniRigheErogateDatiAggiuntivi
			SET
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MsgOrdiniRigheErogateDatiAggiuntiviUpdate] TO [DataAccessMsg]
    AS [dbo];
