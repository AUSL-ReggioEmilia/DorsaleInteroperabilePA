...
-- =============================================
CREATE PROCEDURE [dbo].[MsgOrdiniRigheErogateDatiAggiuntiviInsert]
...
BEGIN
	...
	BEGIN TRY
		...
		-- INSERT
		------------------------------		
		INSERT INTO OrdiniRigheErogateDatiAggiuntivi
		(
			  ID
			, DataInserimento
			, DataModifica
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MsgOrdiniRigheErogateDatiAggiuntiviInsert] TO [DataAccessMsg]
    AS [dbo];
