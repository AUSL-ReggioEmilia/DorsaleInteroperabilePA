...
Module GestioneErrori
    ...
    Public Function TrapError(exception As Exception) As String
        ...
        ' MODIFICA ETTORE 2019-10-24: se errore di ThreadAbortException esco restituendo stringa vuota (questo messaggio è altamente specifico e non va mostrato all'utente)
        ...
        dicProp.Add("NomePortale", "PortalHome-User")
        'Traccio l'errrore su Application Insight.
