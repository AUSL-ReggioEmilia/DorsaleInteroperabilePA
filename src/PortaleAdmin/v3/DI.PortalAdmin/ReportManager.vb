...
Namespace DI.PortalAdmin.Reports
    ...
    Public NotInheritable Class ReportManager
        ...
        ''' <param name="portalName">Il nome del portale che richiede la lista, scelto fra i valori della classe <see cref="DI.PortalAdmin.Reports.ReportingPortalsNames"></see></param>
        ''' <param name="reportingUrl">l'url del server di reporting</param>
