...
-- Description: Derivata dalla [dbo].[GetRicoveriOscuramentiPuntuali] e dbo.GetRicoveriOscuramenti()
--				Restituisce la lista degli Oscuramenti di un ricovero
--				In base ai paramentri discrimina fra Oscuramenti Puntuali/Massivi e oscuramenti da applicare al DWH o a SOLE
--				Il parametro @IdOscuramento non ha utilizzo per ora per i ricoveri
...
-- =============================================
CREATE FUNCTION [dbo].[OttieniRicoveroOscuramenti]
(
