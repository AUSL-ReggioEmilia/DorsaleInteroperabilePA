...
-- Description:	Restituisce lista pazieti per generalità
-- =============================================
CREATE PROCEDURE dbo.PazientiWsByGeneralita
(
	@Identity varchar(64),
	@Cognome varchar(64),
	@Nome varchar(64),
...
BEGIN
	...
	BEGIN
		EXEC PazientiEventiAccessoNegato @Identity, 0, 'PazientiCercaByGeneralita', 'Utente non ha i permessi di lettura!'

		RAISERROR('Errore di controllo accessi durante PazientiCercaByGeneralita!', 16, 1)
		RETURN
	END
	--
	...
	WHERE
		...
		AND ComuneNascitaCodice = @ComuneNascitaCodice
		AND  EXISTS(
			SELECT * 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PazientiWsByGeneralita] TO [DataAccessWs]
    AS [dbo];
