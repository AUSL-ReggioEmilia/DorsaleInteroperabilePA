...
#End Region
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		Try
			...
			'Controllo la validità della richiesta
			...
			If Not IsPostBack Then
				...
				Else
					...
					'
					ucTestataPaziente.UrlDettaglioConsensi = String.Format("~/AccessoDiretto/GestioneConsensi.aspx?IdPaziente={0}", sIdPaziente)
	...
	Private Sub BtnAnnulla_Click(sender As Object, e As EventArgs) Handles BtnAnnulla.Click
		Try
			Response.Redirect(String.Format("~/AccessoDiretto/Referti.aspx?IdPaziente={0}", Me.IdPaziente), False)
		Catch ex As Exception
			'
			' Cancello anche le select dello UserControl per la testata del paziente
			'
	...
	Private Sub GvLista_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GvLista.RowCommand
		Try
			If e.CommandName = "1" Then
				'
				' e.CommandArgument è formattato come "CodiceDocumento;TipoDocumento"
				'
				...
				Dim sUrl As String = String.Format("~/AccessoDiretto/FSE/Documento.aspx?CodiceDocumento={0}&CodiceFiscalePaziente={1}&CodiceFiscaleMedico={2}&TipoAccesso={3}&IdPaziente={4}&TipoDocumento={5}&NaturaDocumento={6}", sCodiceDocumento, Me.CodiceFiscalePaziente, Me.CodiceFiscaleMedico, CmbTipoAccesso.SelectedValue, Me.IdPaziente.ToString, sTipoDocumento, sNaturaDocumento)
...
#End Region
	...
	Private Sub GvLista_PreRender(sender As Object, e As EventArgs) Handles GvLista.PreRender
		...
		'
		If GvLista.HeaderRow IsNot Nothing Then
