...
CREATE UNIQUE NONCLUSTERED INDEX [IXU_NumeroNosologico_AziendaErogante]
    ON [dbo].[RicoveriBase]([NumeroNosologico] ASC, [AziendaErogante] ASC) WITH (FILLFACTOR = 70);
...
CREATE NONCLUSTERED INDEX [IX_Reparto_Tipo_Stato]
    ON [dbo].[RicoveriBase]([RepartoCodice] ASC, [TipoRicoveroCodice] ASC, [StatoCodice] ASC) WITH (FILLFACTOR = 70);
