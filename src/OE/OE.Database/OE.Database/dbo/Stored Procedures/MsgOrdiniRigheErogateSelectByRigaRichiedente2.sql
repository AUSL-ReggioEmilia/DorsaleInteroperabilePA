...
-- =============================================
CREATE PROCEDURE [dbo].[MsgOrdiniRigheErogateSelectByRigaRichiedente2]
...
BEGIN
	...
	BEGIN TRY
		...
		WHERE ore.IDOrdineErogatoTestata = @IDOrdineErogatoTestata
			AND ore.IDRigaRichiedente = @IDRigaRichiedente
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MsgOrdiniRigheErogateSelectByRigaRichiedente2] TO [DataAccessMsg]
    AS [dbo];
