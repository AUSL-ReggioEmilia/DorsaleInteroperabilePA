...
CREATE NONCLUSTERED INDEX [IX_MimeStatoComp_MimeType]
    ON [dbo].[AllegatiBase]([MimeStatoCompressione] ASC, [MimeType] ASC) WITH (FILLFACTOR = 70);


GO
CREATE NONCLUSTERED INDEX [FK_RefertoBase_Referti]
    ON [dbo].[AllegatiBase]([DataPartizione] ASC, [IdRefertiBase] ASC) WITH (FILLFACTOR = 70);
