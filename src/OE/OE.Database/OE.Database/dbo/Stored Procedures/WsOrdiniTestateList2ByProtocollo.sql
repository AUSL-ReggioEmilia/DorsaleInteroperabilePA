...
-- Modify date: 2014-10-27 SANDRO: Copiata da [WsOrdiniTestateListByProtocollo5]
...
-- =============================================
CREATE PROCEDURE [dbo].[WsOrdiniTestateList2ByProtocollo]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WsOrdiniTestateList2ByProtocollo] TO [DataAccessWs]
    AS [dbo];
