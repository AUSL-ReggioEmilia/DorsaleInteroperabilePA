...
'
' Per accedere a questa pagina l'utente deve avere il ruolo ATTRIB@UTE_ANOMIMIZZATORE
...
'
Public Class PazienteCercaAnonimizzazione
    ...
    Private mbCanReadAnonimizzazione As Boolean = False
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                '
                mbCanReadAnonimizzazione = Utility.IsUserAnonimizzatore()
                If Not mbCanReadAnonimizzazione Then
                ...
                If Master.TryFindControl(Of HtmlForm)("form1", formMaster) Then
                    formMaster.DefaultFocus = txtFiltroCodiceAnonimizzazione.ClientID
    ...
    Protected Sub btnRicercaButton_Click(sender As Object, e As EventArgs) Handles btnRicercaButton.Click
        Try
            ...
            '
            Dim sIdAnonimo As String = txtFiltroCodiceAnonimizzazione.Text
            '
            ' Verifico che sia stato impostato il il codice di anonimizzazione
            '
            If String.IsNullOrEmpty(sIdAnonimo) Then
                divErrorMessage.Visible = True
            ...
            '
            MainObjectDataSource.SelectParameters("IdAnonimo").DefaultValue = sIdAnonimo
            '
            ' Cancello cache
            ...
            oTracciaOp.TracciaOperazione(PortalsNames.Sac, Page.AppRelativeVirtualPath, "Ricerca codice anonimizzazione", pannelloFiltri, Nothing)
