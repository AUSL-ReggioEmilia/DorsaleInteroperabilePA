...
-- =============================================
CREATE PROCEDURE  [ws3].[PazientiByTesseraSanitaria2]
(
	@MaxNumRow		INTEGER
	, @Ordinamento	VARCHAR(128)
	, @CodiceSanitario VARCHAR(16) --OBBLIGATORIO
...
BEGIN
	...
	SELECT TOP (@MaxNumRow) 
		...
		, P.CodiceSanitario
		, P.ComuneDomicilioCodice AS ComuneDomicilioCodice
		, P.ComuneDomicilioDescrizione  AS ComuneDomicilioDescrizione
	...
	WHERE	
		(P.CodiceSanitario = @CodiceSanitario)
