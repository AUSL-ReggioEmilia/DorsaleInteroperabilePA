<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
	CodeBehind="UtentiConsensiLista.aspx.vb" Inherits="DI.Sac.Admin.UtentiConsensiLista" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
	...
	<table class="toolbar">
		<tr>
			<td>
				<asp:HyperLink ID="lnkNuovo" runat="server" NavigateUrl="~/Utenti/UtenteConsensoDettaglio.aspx?mode=insert"><img src="../Images/newitem.gif" alt="Nuovo utente" class="toolbar-img"/>Nuovo utente</asp:HyperLink>
			</td>
		</tr>
	</table>
	<br />
	<asp:GridView ID="gvUtentiPazienti" runat="server" AllowPaging="True" AllowSorting="True"
		...
		<Columns>
			<asp:HyperLinkField DataTextField="Utente" DataNavigateUrlFormatString="~/Utenti/UtenteConsensoDettaglio.aspx?mode=edit&id={0}"
	...
	<asp:ObjectDataSource ID="MainObjectDataSource" runat="server" SelectMethod="GetData"
		TypeName="DI.Sac.Admin.Data.UtentiDataSetTableAdapters.UtentiConsensiListaTableAdapter"
