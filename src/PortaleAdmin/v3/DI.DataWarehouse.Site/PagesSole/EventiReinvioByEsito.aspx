<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="EventiReinvioByEsito.aspx.vb" Inherits=".EventiReinvioByEsito" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <div Id="divLegenda" class="Title" style="width: 600px;">
        Imposta il reinvio a SOLE degli eventi il cui esito dell'invio è "In Errore" o "Da inviare"
    </div>
    ...
    <asp:GridView ID="gvMain" runat="server" DataSourceID="odsMain" AllowPaging="True" AllowSorting="true" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="IdEvento" HeaderText="IdEvento" SortExpression="IdEvento"></asp:BoundField>
            ...
            <asp:BoundField DataField="TipoEvento" HeaderText="Tipo Evento" SortExpression="TipoEvento"></asp:BoundField>
    ...
    <asp:ObjectDataSource ID="odsMain" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="DI.DataWarehouse.Admin.Data.SoleTableAdapters.EventiReinvioMassivoCercaTableAdapter">
        <SelectParameters>
    ...
    <script type="text/javascript">
        ...
        */
        $(".btn-riprocessa").click(function () {
            ...
            return confirm('Verranno riprocessati ' + numero + ' eventi. \nProseguire?');
        });

        $(".btn-annullaRiprocessamento").click(function () {
            return confirm('Verrà annullato il riprocessamento degli eventi mancanti. \n Proseguire?');
        });
