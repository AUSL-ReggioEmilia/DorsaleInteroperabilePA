<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TranscodificaRegimiDettaglio.aspx.vb" Inherits=".TranscodificaRegimiDettaglio" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <asp:Label ID="lblError" runat="server" CssClass="Error" EnableViewState="False"></asp:Label>

    <label class="Title">Dettaglio transcodifica regime</label>
    ...
    <asp:ObjectDataSource ID="odsMain" runat="server" OldValuesParameterFormatString="{0}" SelectMethod="GetDataById" InsertMethod="Insert" TypeName="TranscodificheDataSetTableAdapters.TranscodificaRegimiOttieniTableAdapter" UpdateMethod="Update" DeleteMethod="Delete">
        <InsertParameters>
