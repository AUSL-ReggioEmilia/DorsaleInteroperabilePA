    ...
    Public Class Global_asax
        ...
        Sub Session_Start(ByVal sender As Object, ByVal e As EventArgs)
            Try
                ...
                portal.TracciaAccessi(userName, PortalsNames.PrintDispatcher, String.Format("Accesso effettuato il {0} alle ore {1}", now.ToString("dd/MM/yyy"), now.ToString("HH:mm:ss")))
                '
                ...
                Dim oUltimoAccesso As SessioneUtente.UltimoAccesso = oSess.GetUltimoAccesso(User.Identity.Name, PortalsNames.PrintDispatcher)
                '
            ...
            Try
                ...
                If Not String.IsNullOrEmpty(sDiPortalUserConnectionString) Then
                    ...
                    If lastException IsNot Nothing Then
                        ...
                        portal.TracciaErrori(lastException, User.Identity.Name, PortalsNames.PrintDispatcher)
                    End If
                Else
                    '
        ...
        Sub Session_End(ByVal sender As Object, ByVal e As EventArgs)
            Try
                ...
                portal.TracciaAccessi(userName, PortalsNames.PrintDispatcher, String.Format("L'utente si è disconnesso il {0} alle ore {1}", accessDate.ToString("dd/MM/yyy"), accessDate.ToString("HH:mm:ss")))
            Catch ex As Exception
                '
                'SimoneB - 2017-07-19
                'Se si verificano degli errori nella dll Di.PortalUser2 e non si trappa l'errore si creerebbe un loop.
