...
Namespace DI.Sac.User
    ...
    Public Class SacDropDownList
        ...
        Public Property ServicePath() As String
            Get
                If Not IsNothing(ViewState("ServicePath")) Then
        ...
        Public Property ParentServiceMethod() As String
            Get
                If Not IsNothing(ViewState("ParentServiceMethod")) Then
        ...
        Public Property ParentPromptText() As String
            Get
                If Not IsNothing(ViewState("ParentPromptText")) Then
        ...
        Public Property ParentLoadingText() As String
            Get
                If Not IsNothing(ViewState("ParentLoadingText")) Then
        ...
        Public Property ParentCategory() As String
            Get
                If Not IsNothing(ViewState("ParentCategory")) Then
        ...
        Public Property ChildServiceMethod() As String
            Get
                If Not IsNothing(ViewState("ChildServiceMethod")) Then
        ...
        Public Property ChildPromptText() As String
            Get
                If Not IsNothing(ViewState("ChildPromptText")) Then
        ...
        Public Property ChildLoadingText() As String
            Get
                If Not IsNothing(ViewState("ChildLoadingText")) Then
        ...
        Public Property ChildCategory() As String
            Get
                If Not IsNothing(ViewState("ChildCategory")) Then
        ...
        Public Property BindValue() As String
            Get
                If Not IsNothing(ViewState("BindValue")) Then
        ...
        Protected Overrides Sub CreateChildControls()
            ...
            oParentDropDownList.CssClass = "form-control disabled"
            ...
            oChildDropDownList.CssClass = "form-control disabled"
    ...
    Public Class SacDropDownListDesigner
        ...
        Public Overrides Function GetDesignTimeHtml() As String
            ...
            sString.Append("<select name='{0}' id='{0}' class='form-control'>")
