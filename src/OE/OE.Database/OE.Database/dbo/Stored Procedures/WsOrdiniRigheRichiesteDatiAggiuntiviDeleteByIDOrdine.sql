...
-- =============================================
CREATE PROCEDURE [dbo].[WsOrdiniRigheRichiesteDatiAggiuntiviDeleteByIDOrdine]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WsOrdiniRigheRichiesteDatiAggiuntiviDeleteByIDOrdine] TO [DataAccessWs]
    AS [dbo];
