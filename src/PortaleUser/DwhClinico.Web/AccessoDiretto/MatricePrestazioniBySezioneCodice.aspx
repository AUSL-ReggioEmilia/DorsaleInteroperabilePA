<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AccessoDiretto/AccessoDiretto.master" CodeBehind="MatricePrestazioniBySezioneCodice.aspx.vb" Inherits="DwhClinico.Web.MatricePrestazioniBySezioneCodice1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="row">
        <div class="col-sm-9 col-md-9 col-lg-10">
            ...
            <%--<asp:Button ID="btnCollapseMatrice" ClientIDMode="Static" class="btn btn-default" ng-opened="0" Text="Chiudi tutte le sezioni" runat="server" OnClientClick="changeCollapseBtnText();return false;" />--%>
    ...
    <asp:ObjectDataSource ID="DataSourcePrestazioniMatrice" runat="server"
        SelectMethod="GetData" TypeName="DwhClinico.Web.CustomDataSource.AccessoDirettoMatricePrestazioniLabCercaPerSezioneCodice" OldValuesParameterFormatString="original_{0}">
        <SelectParameters>
