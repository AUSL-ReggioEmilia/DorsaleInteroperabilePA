...
-- Description:	Cerca o aggiunge un paziente
...
-- =============================================
CREATE PROCEDURE [pazienti_ws].[PazientiCercaByProvenienzaIdProvenienzaOrAggiunge]
(
	  @Identity varchar(64)
...
BEGIN
	...
	DECLARE @ProvenienzaIdentity AS varchar(16) --provenienza dell'utente corrente che verrà usata in inserimento
	...
	BEGIN
		RAISERROR('Errore di Provenienza non trovata durante pazienti_ws.PazientiCercaByProvenienzaIdProvenienzaOrAggiunge!', 16, 1)
		RETURN
	END			
	...
	BEGIN TRY
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					EXEC dbo.PazientiEventiAccessoNegato @Identity, 0, 'pazienti_ws.PazientiCercaByProvenienzaIdProvenienzaOrAggiunge', 'Utente non ha i permessi di scrittura!'
					RAISERROR('Errore di controllo accessi durante pazienti_ws.PazientiCercaByProvenienzaIdProvenienzaOrAggiunge!', 16, 1)
					RETURN
				END
					...
					BEGIN
						...
						BEGIN
							EXEC dbo.PazientiBaseMerge
									...
									, @Note = 'Merge eseguita da pazienti_ws.PazientiCercaByProvenienzaIdProvenienzaOrAggiunge'
							--
							-- uso Tipo=6 come per i WS visto che l'inserimento viene fatto con PazientiWsBaseInsert2
							--
							EXEC dbo.PazientiNotificheAdd @Id, 6, @Identity --0=Msg; 1= UI; 2=WS; 3=Batch;4=Msg-notifica merge;5=UI-notifica merge; 6=ws-merge 
							--
