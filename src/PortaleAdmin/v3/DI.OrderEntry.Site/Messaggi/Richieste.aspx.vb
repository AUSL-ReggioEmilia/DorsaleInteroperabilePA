...
Namespace DI.OrderEntry.Admin
    ...
    Public Class Richieste
        ...
        Private Const PageSessionIdPrefix As String = "MessaggiRichieste_"
        ...
        Public Shared Function GetMessaggioOriginale(ByVal id As String) As String
            ...
            Dim dataTable As New UiMessaggiRichiesteSelectDataTable()
        ...
        Private Sub ClearFilterButton_Click(sender As Object, e As EventArgs) Handles ClearFilterButton.Click
            ...
            Me.PageIndex = 0
            Me.RichiesteGridView.Sort(String.Empty, SortDirection.Ascending)
