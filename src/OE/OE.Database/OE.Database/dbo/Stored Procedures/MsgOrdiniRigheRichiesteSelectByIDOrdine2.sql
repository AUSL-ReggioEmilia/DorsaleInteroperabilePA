...
-- Description:	Seleziona le riga ordine richieste by idordine con dati sistema e prestazioni
-- =============================================
CREATE PROCEDURE [dbo].[MsgOrdiniRigheRichiesteSelectByIDOrdine2]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MsgOrdiniRigheRichiesteSelectByIDOrdine2] TO [DataAccessMsg]
    AS [dbo];
