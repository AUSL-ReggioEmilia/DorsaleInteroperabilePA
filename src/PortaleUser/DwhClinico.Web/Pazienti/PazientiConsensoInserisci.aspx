...
<%@ Page Language="VB" MasterPageFile="~/Portale/Default.master" AutoEventWireup="false"
    Inherits="DwhClinico.Web.Pazienti_PazientiConsensoInserisci" Title="" CodeBehind="PazientiConsensoInserisci.aspx.vb" %>
    ...
    <div style="margin-top: 5px; margin-left: 5px">
        ...
        <table cellspacing="0" cellpadding="0" width="90%">
            <tr>
                ...
                <td>
                    <input type="button" id="cmdAnnulla" runat="server" value="Annulla" />
                </td>
                <td align="right">
                    <input type="button" value="Apri informativa" name="cmdInformativa" id="cmdInformativa"
                        runat="server" />
                </td>
            </tr>
        </table>
