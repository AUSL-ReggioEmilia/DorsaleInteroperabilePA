...
'
' Per accedere a questa pagina l'utente avere il ruolo ROLE_PAZIENTI_CREATE_ANONIMIZZAZIONE
' La pagina verifica se l'utente ha i permessi per ceare una anonimizzazione
' La pagina utilizza come parametro l'Id (guid) del paziente da anonimizzare
' La SP utilizzata per creare l'anonimizzaione verifica a sua volta se l'anagrafica è attiva
'
    ...
    Protected Sub btnConferma_Click(sender As Object, e As EventArgs) Handles btnConferma.Click
        ...
        Try
            Using odt As New PazientiAnonimizzazioniDataSet.PazientiAnonimizzazioniSelectDataTable
                ...
                ' MODIFICA ETTORE 2016-02-12: passo l'idpaziente SAC del record ottenuto dall'anonimizzazione
                '
            ...
            oTracciaOp.TracciaOperazione(PortalsNames.Sac, Page.AppRelativeVirtualPath, "Anonimizzata anagrafica", mIdPaziente)
