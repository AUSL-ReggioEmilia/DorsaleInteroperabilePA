...
Public Class MatricePrestazioniBySezioneCodice1
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            'MOSTRO UN MESSAGGIO DI ERRORE NEL CASO IN CUI LA SESSIONE SIA SCADUTA ( NON REDIRIGO ALLA HOME PERCHE' NON CONOSCO L'ENTRY POINT).
...
#Region "GestioneFiltriLaterali"
    ...
    Private Sub CaricaFiltri()
        Try
            ...
            Dim RefertiListaId As String = "AccessoDiretto_Referti"
...
#End Region
    ...
    Private Sub CmdEsci_Click(sender As Object, e As EventArgs) Handles CmdEsci.Click
        Try
            ...
            Response.Redirect(SessionHandler.AccessoDirettoRefertoUrl, False)
        Catch ex As Exception
            divErrorMessage.Visible = True
