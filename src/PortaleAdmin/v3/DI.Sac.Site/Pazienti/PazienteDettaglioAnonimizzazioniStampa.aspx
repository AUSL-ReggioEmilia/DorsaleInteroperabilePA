    ...
    <form id="form1" runat="server">
        ...
        <div align="center" style="width: 100%;">
            <div id="MainDiv" runat="server" style="width: 16.5cm;">
                <div>
                    <asp:Image ID="imgToolbar1" runat="server" ImageUrl="/Images/LogoAzienda.jpg" Width="400" Height="74" />
                </div>
                ...
                <div class="DetailPanel">
                    ...
                    <div id="divEsenzioni" runat="server" style="width: 100%;">
                        ...
                        <asp:GridView runat="server" ID="gvEsenzioni" DataSourceID="EsenzioniObjectDataSource" AutoGenerateColumns="False" Width="100%">
            ...
            <asp:ObjectDataSource runat="server" ID="EsenzioniObjectDataSource" SelectMethod="GetData" TypeName="EsenzioniPaziente" OldValuesParameterFormatString="original_{0}">
                <SelectParameters>
