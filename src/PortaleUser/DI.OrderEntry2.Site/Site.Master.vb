...
Namespace DI.OrderEntry.User
    ...
    Partial Public Class Site
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
            Try
                '2020--02-13 MODIFICA KYRYLO Verifico se nell'URL c'è "ORDERENTRYACCESSODIRETTO"; se si nego l'accesso alla paere standard dell'OE
                'Memorizzo il pth dell'url corente
                Dim sPath As String = Request.Url.PathAndQuery.ToUpper
                Dim bVirtulOeAccessoDiretto As Boolean = sPath.Contains("ORDERENTRYACCESSODIRETTO")
                ...
                If Not IsPostBack Then
                    ...
                    '2020--02-13 MODIFICA KYRYLO Verifico se nell'URL c'è "ORDERENTRYACCESSODIRETTO"; se si nego l'accesso alla paere standard dell'OE
                    If Not bVirtulOeAccessoDiretto Then
                        PopulateMenu()
                    End If
                ...
                '2020--02-13 MODIFICA KYRYLO Verifico se nell'URL c'è "ORDERENTRYACCESSODIRETTO"; se si nego l'accesso alla paere standard dell'OE
                If bVirtulOeAccessoDiretto Then
                    'Usare endresponse = false altrimenti si genera ThradAbortExdception
                    Me.NavigateToErrorPage(Utility.ErrorCode.AccessDenied, "", False)
                End If
        ...
        Private Sub PopulateMenu()
            ...
            Dim adapter As New PortalDataAdapterManager(Global_asax.ConnectionStringPortalUser)

            Dim idPortale As Integer = PortalDataAdapterManager.EnumPortalId.OrderEntry
