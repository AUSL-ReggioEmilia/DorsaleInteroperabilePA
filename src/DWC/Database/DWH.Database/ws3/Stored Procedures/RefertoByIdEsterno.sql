...
-- Description:	Restituisce i dati di TESTATA referto per IdEsterno del referto
-- Modify date: 2019-06-22: restituisco lo stato di visibilità del referto: sarà il servizio WEB a generare l'eccezione per segnalare se il referto esiste o non è visibile
-- =============================================
CREATE PROCEDURE [ws3].[RefertoByIdEsterno]
(
