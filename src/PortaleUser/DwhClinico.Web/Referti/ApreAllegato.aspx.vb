...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                Dim dettaglioReferto As WcfDwhClinico.RefertoType
                ...
                If bAccessoDiretto Then
                    '
                    ' Uso la customDataSource AccessoDirettoRefertoOttieniPerId perchè non fa cache
                    '
                    Dim RefertoOttieniPerId As New CustomDataSource.AccessoDirettoRefertoOttieniPerId
                    dettaglioReferto = RefertoOttieniPerId.GetData(Me.Token, IdReferto)
                Else
                    '
                    ' Uso la customDataSource RefertoOttieniPerId perchè non fa cache
                    '
