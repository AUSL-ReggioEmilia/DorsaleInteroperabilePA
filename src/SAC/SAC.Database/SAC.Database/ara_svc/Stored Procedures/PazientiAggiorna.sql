...
-- =============================================
-- Author:		Vito Carrieri
-- Create date: 2020-10-26
-- Description:	Aggiorna una anagrafica ARA da servizio
--				Verifica incoerenza ISTAT direttamente da SP
--				Se non trova il record paziente lo inserisce. E' corretto?
--				In teoria dovrebbe solo aggiornare!!!
-- =============================================
CREATE PROCEDURE [ara_svc].[PazientiAggiorna]
(
@Identity VARCHAR(64)
...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			BEGIN 
				--
				-- Anche se non aggiorno i dati del paziente aggiorno la DataModifica, cosi il record non verrà più inserito nella coda alla prossima lettura
				--
				UPDATE dbo.Pazienti
					SET DataModifica = GETDATE()					 
				WHERE Id = @IdPaziente
