Public Class SistemiErogantiDetail
    ...
    '
    Private Const PAGE_LIST As String = "SistemiErogantiList.aspx"

    Private Const PAGE_DETAIL As String = "SistemiErogantiDetail.aspx"
    ...
    Private Function MyValidate(ByVal oValue As IOrderedDictionary) As String
        ...
        For Each sKey As String In oValue.Keys
            If sKey = "Codice" Then
                ...
                If String.IsNullOrEmpty(sCodice) Then sMsgError = sMsgError & String.Concat(vbCrLf, String.Format("Il campo '{0}' è obbligatorio.", "Codice"))
            ElseIf sKey = "CodiceAzienda" Then
                sCodiceAzienda = oValue(sKey).ToString
                If String.IsNullOrEmpty(sCodiceAzienda) Then sMsgError = sMsgError & String.Concat(vbCrLf, String.Format("Il campo '{0}' è obbligatorio.", "CodiceAzienda"))
            ElseIf sKey = "Descrizione" Then
                sDescrizione = oValue(sKey).ToString
                If String.IsNullOrEmpty(sDescrizione) Then sMsgError = sMsgError & String.Concat(vbCrLf, String.Format("Il campo '{0}' è obbligatorio.", "Descrizione"))
            ElseIf sKey = "Attivo" Then
    ...
    Private Sub MainListDataSource_Selecting(sender As Object, e As ObjectDataSourceSelectingEventArgs) Handles MainListDataSource.Selecting
        ...
        Try
            ...
            Else
                ...
                '
                e.InputParameters("IdSistemiEroganti") = _id
            End If
        Catch ex As Exception
...
#Region "Funzioni chiamate nel markup"
    ...
    Protected Function GetEditItemNavigateUrl(ByVal Id As Object, ByVal IdSistemiEroganti As Object) As String
        ...
        'Return sUrl & "?Id=" & DirectCast(Id, Guid).ToString & "&IdSistemiEroganti"
        sUrl = String.Concat(sUrl, "?Id=", DirectCast(Id, Guid).ToString, "&IdSistemiEroganti=", DirectCast(IdSistemiEroganti, Guid).ToString)
        Return sUrl
    End Function

    Protected Function GetNewItemNavigateUrl() As String
        Dim sUrl As String = Me.ResolveUrl("~/SistemiErogantiModuliDetail.aspx")
        Return sUrl & "?IdSistemiEroganti=" & _id
    End Function
