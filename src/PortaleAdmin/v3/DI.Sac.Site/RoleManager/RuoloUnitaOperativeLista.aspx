<%@ Page Title="Unità Operative" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
	CodeBehind="RuoloUnitaOperativeLista.aspx.vb" Inherits=".RuoloUnitaOperativeLista" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
	<script type="text/javascript" src="../Scripts/PopUp.js"></script>
	<script>
		function PopUp_AttributiInserisci(IdUnita) {
			commonModalDialogOpen('AttributiInserisci.aspx?IdUnita=' + IdUnita + '&Id=' + $.QueryString['Id'], '', 580, 360);
			return false;
		}
	</script>
	...
	<asp:GridView ID="gvLista" runat="server" AllowPaging="True" AllowSorting="True"
		...
		DataKeyNames="Id,IdUnitaOperativa" CssClass="GridYellow" HeaderStyle-CssClass="Header"
		...
		<Columns>
            ...
            <asp:CheckBoxField DataField="Attivo" HeaderText="Attivo" ReadOnly="True" SortExpression="Attivo" ItemStyle-Width="60px" />
	...
	<asp:ObjectDataSource ID="odsLista" runat="server" SelectMethod="GetData" TypeName="OrganigrammaDataSetTableAdapters.RuoliUnitaOperativeTableAdapter"
		CacheDuration="120" CacheKeyDependency="CacheRuoloUnitaOperative" DeleteMethod="Delete"
