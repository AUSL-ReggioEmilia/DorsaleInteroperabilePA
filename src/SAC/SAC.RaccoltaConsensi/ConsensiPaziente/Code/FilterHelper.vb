...
' ULTIMA MODIFICA: 2015-12-29  V 1.1.2
...
Public NotInheritable Class FilterHelper
	...
	Public Shared Sub SaveInSession(Container As Control)
		SaveInSession(Container, Container.Page.GetType().BaseType.FullName)
	End Sub
	...
	''' </summary>
	Public Shared Function GetSavedValue(control As Control) As Object

		Return GetSavedValue(control, control.Page.GetType().BaseType.FullName)
	...
	''' </summary>
	Public Shared Sub Restore(Container As Control)
		Restore(Container, Container.Page.GetType().BaseType.FullName)
	End Sub
	...
	Public Shared Sub Clear(parent As Control)
		...
		Clear(parent, parent.Page.GetType().BaseType.FullName)
