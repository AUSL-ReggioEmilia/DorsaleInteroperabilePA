...
'************************************************************************************************************************
' MODIFICHE:
'   1)  In seguito a modifica dei consensi ho gestito i nuovi tipi di consenso DOSSIER, DOSSIERSTORICO
'************************************************************************************************************************
Public Class PazientiConsensoInserisci
    ...
    End Property
    '
    ' Contiene l'URL a cui si deve navigare per la visualizzazione dei referti/ricoveri
    '
    Dim mUrlToNavigate As String
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            '
            ' Verifico la presenza del'URL agli aggetti da visualizzare
            '
            mUrlToNavigate = Request.QueryString(PAR_URL_TO)
            If String.IsNullOrEmpty(mUrlToNavigate) Then
                Throw New Exception(String.Format("Il parametro '{0}' è obbligatorio.", PAR_URL_TO))
            End If
            '
            ...
            If Not IsPostBack Then
                ...
                '
                BarraNavigazione.SetCurrentItem("Inserisci consenso", "")
            End If
            '
    ...
    Private Sub InitializePage()
        ...
        'strScript = "javascript:return confirm('Confermi l´inserimento del consenso?');"
        ...
        strScript = "javascript:document.location.href='PazientiConsenso.aspx?" & PAR_ID_PAZIENTE & "=" & mguidIdPaziente.ToString & "&" & PAR_URL_TO & "=" & sParUrlTo & "'"
    ...
    Private Sub cmdOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOK.Click
        ...
        Try
            ...
            If iConsensoStato > -1 Then
                ...
                '
                Dim sParUrlTo As String = Server.UrlEncode(mUrlToNavigate)
                Response.Redirect(String.Format("PazientiConsenso.aspx?{0}={1}&{2}={3}", PAR_ID_PAZIENTE, mguidIdPaziente.ToString, PAR_URL_TO, sParUrlTo), False)
