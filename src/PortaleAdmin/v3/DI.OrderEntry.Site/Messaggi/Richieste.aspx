<%@ Page Title="Richieste" Language="vb" AutoEventWireup="false" MasterPageFile="~/OrderEntry.Master" CodeBehind="Richieste.aspx.vb"
	Inherits="DI.OrderEntry.Admin.Richieste" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="OrderEntryContentPlaceHolder" runat="server">
	...
	<div id="filterPanel" runat="server">
		<fieldset class="filters">
			...
			<div>
				...
				<asp:TextBox ID="DataInserimentoDaTextBox" runat="server" Width="163px" />
			</div>
			<div>
				<span>a</span>
				<asp:TextBox ID="DataInserimentoATextBox" runat="server" Width="163px" />
			</div>
			<div>
				<span>Stato</span>
		...
		<fieldset class="filters">
			...
			<div>
				...
				<asp:TextBox ID="CodiceSistemaRichiedenteTextBox" runat="server" Width="163px" />
			</div>
			<div>
				<span>Numero Ordine</span>
				<asp:TextBox ID="IdRichiestaTextBox" runat="server" Width="163px" />
			</div>
			<div style="display: none;">
				<span>Campo nascosto</span>
				<asp:TextBox ID="FiltroAvanzatoTextBox" runat="server" Text="chiuso" />
			</div>
		</fieldset>
	</div>
	...
	<div id="gridPanel">
		<asp:GridView ID="RichiesteGridView" runat="server" AllowPaging="True" AllowSorting="True" CssClass="Grid" AutoGenerateColumns="False"
			DataKeyNames="ID" DataSourceID="MainObjectDataSource" EnableModelValidation="True" PageSize="100" PagerSettings-Position="TopAndBottom"
			Width="100%">
		...
		<asp:ObjectDataSource ID="MainObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData"
			TypeName="DI.OrderEntry.Admin.Data.MessaggiTableAdapters.UiMessaggiRichiesteListTableAdapter">
			<SelectParameters>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			var inserimentoDataDaClientId = "#<%=DataInserimentoDaTextBox.ClientID %>";
			var inserimentoDataAClientId = "#<%=DataInserimentoATextBox.ClientID %>";
		});
	...
	<script type="text/javascript" src="../Scripts/messaggi-richieste.js"></script>
</asp:Content>
