<%@ Page Language="VB" MasterPageFile="~/Portale/Default.master" AutoEventWireup="false" Inherits="DwhClinico.Web.Referti_RefertiListaPaziente"
    Title="" CodeBehind="RefertiListaPaziente.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="row">
        <div class="col-sm-9 col-md-9 col-lg-10">
            ...
            <div id="TableReportContainer" runat="server">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <%-- TAB CALENDARIO --%>
                    <li id="CalendarioTab" runat="server">
                    ...
                    <li id="tabLnkRefertiEpisodi" runat="server">
                        <asp:LinkButton ID="lnkRefertiEpisodi" CssClass="ReportGroupUnSelectedTab" runat="server"
                            ...
                            CausesValidation="False" Font-Underline="False">Episodi e Referti</asp:LinkButton></li>
                    ...
                    <li id="tabLnkRisultatoMatrice" runat="server">
                        <asp:LinkButton ID="lnkRisultatoMatrice" CssClass="ReportGroupUnSelectedTab" runat="server"
                            ...
                            CausesValidation="False" Font-Underline="False">Risultato matrice</asp:LinkButton>
                    </li>

                    <%-- TAB IMPEGNATIVE --%>
                    <li id="PrescrizioniTab" runat="server">
                        <asp:LinkButton ID="lnkPrescrizioni" CssClass="ReportGroupUnSelectedTab" runat="server"
                            ...
                            CausesValidation="False" Font-Underline="False">Impegnative</asp:LinkButton>
                    </li>

                    <%-- TAB SCHEDE PAZIENTE --%>
                    <li id="SchedePazienteTab" runat="server">
                        <asp:LinkButton ID="lnkSchedePaziente" CssClass="ReportGroupUnSelectedTab" runat="server"
                            ...
                            CausesValidation="False" Font-Underline="False">Schede Paziente</asp:LinkButton>
                    </li>

                    <%-- TAB NOTE ANAMNESTICHE --%>
                    <li id="NoteAnamnesticheTab" runat="server">
                        <asp:LinkButton ID="lnkNoteAnamnestiche" CssClass="ReportGroupUnSelectedTab" runat="server"
                            OnCommand="SelectView" CommandArgument="ViewNoteAnamnestiche" CommandName="TabClick"
                            CausesValidation="False" Font-Underline="False">Note Anamnestiche</asp:LinkButton>
                    </li>
                ...
                <asp:MultiView ID="MultiViewMain" runat="server">
                        ...
                        <div id="divWebGridReferti" runat="server">
                            <div class="table-responsive">
                                ...
                                <asp:GridView ID="WebGridReferti" EnableViewState="false"
                                    DataKeyNames="Id,AziendaErogante,SistemaErogante,Cognome,Nome,NumeroNosologico,NumeroReferto" AllowSorting="false" ShowHeader="false" ClientIDMode="Static" GridLines="None" CssClass="table table-bordered table-condensed small" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="1%" HeaderStyle-Width="1%" ItemStyle-CssClass="icon-align">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="hlEliminaReferto" runat="server"
                                                    NavigateUrl='<%# GetUrlCancellaReferto(Container.DataItem) %>'
                                                    Visible='<%# CheckDeleteRefertiPermission() %>' ToolTip="Oscura referto">
                                ...
                                <asp:ObjectDataSource ID="DataSourceMain" runat="server" SelectMethod="GetData"
                                    TypeName="DwhClinico.Web.CustomDataSource.RefertiCercaPerIdPaziente" OldValuesParameterFormatString="original_{0}">
                                    <SelectParameters>
                                        <asp:Parameter Name="Token" Type="Object" />
                                        <asp:Parameter Name="Ordinamento" Type="String" />
                                        <asp:Parameter Name="IdPaziente" DbType="Guid" />
                                        <asp:ControlParameter ControlID="txtDataDal" PropertyName="Text" Name="DallaData" Type="DateTime"></asp:ControlParameter>
                                        <asp:Parameter Name="ByPassaConsenso" Type="Boolean"></asp:Parameter>
                                        <asp:ControlParameter ControlID="txtAllaData" PropertyName="Text" Name="AllaData" Type="DateTime"></asp:ControlParameter>
                    ...
                    <asp:View ID="ViewRefertiEpisodi" runat="server">
                        ...
                        <div id="divWebGridRefertiEpisodi" runat="server">
                            <div class="table-responsive">
                                <asp:GridView ShowHeader="false" ClientIDMode="Static" EnableViewState="false" ID="WebGridRefertiEpisodi" AllowPaging="true" AllowSorting="false" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <%-- 
                                                    ATTENZIONE:
                                                    La creazione dei gruppi dei referti per ogni episodio viene gestita nel RowDataBound della griglia WebGridRefertiEpisodi
                                                --%>
                                                <asp:GridView ID="WebGridrefertiPerNosologico" ShowHeader="false"
                                                    DataKeyNames="Id,AziendaErogante,SistemaErogante,Cognome,Nome,NumeroNosologico,NumeroReferto" ClientIDMode="Static" GridLines="None"
                                                    CssClass="table table-bordered table-condensed" runat="server" AutoGenerateColumns="False" OnRowDataBound="WebGridrefertiPerNosologico_RowDataBound"
                                                    DataSourceID="DataSourceRefertiPerNosologico" OnPreRender="WebGridrefertiPerNosologico_PreRender">
                                                    <Columns>
                                                        <asp:TemplateField ItemStyle-Width="2%" HeaderStyle-Width="2%" ItemStyle-CssClass="icon-align">
                                                            <ItemTemplate>
                                                                <%-- 
                                                                    ATTENZIONE:
                                                                    Nel RowDataBound della griglia WebGridRefertiEpisodi viene aggiunto una classe CSS a questa checkbox.
                                                                    Questa classe CSS viene usata per selezionare e deselezionare le checkbox dei referti di un episodio al click sul bottone " Seleziona tutti"
                                                                --%>
                                                                <asp:CheckBox ID="chkSelect" ClientIDMode="AutoID" runat="server" EnableViewState="true" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField ItemStyle-Width="1%" HeaderStyle-Width="1%" ItemStyle-CssClass="icon-align">
                                                            <ItemTemplate>
                                                                <asp:HyperLink ID="hlEliminaReferto" runat="server"
                                                                    NavigateUrl='<%# GetUrlCancellaReferto(Container.DataItem) %>'
                                                                    Visible='<%# CheckDeleteRefertiPermission() %>'>
                                                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                                                                </asp:HyperLink>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                ...
                                                <asp:ObjectDataSource ID="DataSourceRefertiPerNosologico" runat="server" SelectMethod="GetData"
                                                    TypeName="DwhClinico.Web.CustomDataSource.RefertiCercaPerNosologico" OldValuesParameterFormatString="original_{0}"
                                ...
                                <asp:ObjectDataSource ID="DataSourceEpisodi" runat="server" SelectMethod="GetData"
                                    TypeName="DwhClinico.Web.CustomDataSource.EpisodiCercaPerIdPaziente" OldValuesParameterFormatString="original_{0}">
                                    <SelectParameters>
                                        <asp:Parameter Name="Token" Type="Object" />
                                        <asp:Parameter Name="Ordinamento" Type="String" />
                                        <asp:Parameter Name="IdPaziente" DbType="Guid" />
                    ...
                    <asp:View ID="ViewRisultatoMatrice" runat="server">
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:ObjectDataSource ID="DataSourcePrestazioniMatrice" runat="server"
                                SelectMethod="GetData" TypeName="DwhClinico.Web.CustomDataSource.MatricePrestazioniLabCercaPerIdPaziente" OldValuesParameterFormatString="original_{0}">
                                <SelectParameters>
                                    <asp:Parameter Name="Token" Type="Object" />
                                    <asp:Parameter Name="Ordinamento" Type="String" />
                        ...
                        <div id="divWebGridPrescrizione" runat="server">
                            <div class="table-responsive">
                                <asp:GridView runat="server" EnableViewState="false" ShowHeader="true" ID="WebGridPrescrizioni" AutoGenerateColumns="False"
                                    DataSourceID="DataSourcePrescrizioni" CssClass="Grid table table-striped table-condensed table-bordered small" DefaultColumnWidth=""
                                ...
                                <asp:ObjectDataSource ID="DataSourcePrescrizioni" runat="server" SelectMethod="GetData"
                                    TypeName="DwhClinico.Web.CustomDataSource.PrescrizioniCercaPerIdPaziente" OldValuesParameterFormatString="original_{0}">
                                    <SelectParameters>
                                        <asp:Parameter Name="Token" Type="Object" />
                                        <asp:Parameter Name="Ordinamento" Type="String" />
                                        <asp:Parameter DbType="Guid" Name="IdPaziente"></asp:Parameter>
                                        ...
                                        <asp:Parameter Name="ByPassaConsenso" Type="Boolean"></asp:Parameter>
                                        <asp:ControlParameter ControlID="txtAllaData" PropertyName="Text" Name="AllaData" Type="DateTime"></asp:ControlParameter>
                                        <asp:Parameter Name="lstFiltriTipiPrescrizione" Type="Object"></asp:Parameter>
                                    </SelectParameters>
                                </asp:ObjectDataSource>
                            </div>
                        </div>
                    ...
                    <asp:View ID="ViewSchedePaziente" runat="server">
                        ...
                        <div id="divWebGridEventiSingoli" runat="server">
                            <div class="table-responsive" id="TableEventiSingoli" runat="server">
                                <asp:GridView ID="WebGridEventiSingoli"
                                    DataKeyNames="Id,AziendaErogante,SistemaErogante,Cognome,Nome,NumeroNosologico,NumeroReferto" ShowHeader="false" ClientIDMode="Static" GridLines="None" CssClass="table table-bordered table-condensed small" runat="server"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Width="2%" HeaderStyle-Width="2%" ItemStyle-CssClass="icon-align">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkSelect" CssClass="chkSelect1" runat="server" EnableViewState="false" Visible="true" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="1%" HeaderStyle-Width="1%" ItemStyle-CssClass="icon-align">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="hlEliminaReferto" runat="server"
                                                    NavigateUrl='<%# GetUrlCancellaReferto(Container.DataItem) %>'
                                                    Visible='<%# CheckDeleteRefertiPermission() %>' ToolTip="Oscura referto"><span class="glyphicon glyphicon-remove" aria-hidden="true"></asp:HyperLink>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>

                                <asp:ObjectDataSource ID="DataSourceRefertiSingoli" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="DwhClinico.Web.CustomDataSource.RefertiCercaRefertiSingoli">
                                    <SelectParameters>
                                        <asp:Parameter Name="Token" Type="Object"></asp:Parameter>
                                        <asp:Parameter Name="Ordinamento" Type="String"></asp:Parameter>
                                        <asp:Parameter DbType="Guid" Name="IdPaziente"></asp:Parameter>
                    ...
                    <asp:View ID="ViewNoteAnamnestiche" runat="server">
                        ...
                        <div id="divWebGridNoteAnamnestiche" runat="server">
                            <div class="table-responsive">
                                ...
                                <asp:ObjectDataSource ID="DataSourceNoteAnamnestiche" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="DwhClinico.Web.CustomDataSource.NoteAnamnesticheCercaPerIdPaziente">
                                    <SelectParameters>
                                        <asp:Parameter Name="Token" Type="Object"></asp:Parameter>
                                        <asp:Parameter Name="Ordinamento" Type="String"></asp:Parameter>
                                        <asp:Parameter DbType="Guid" Name="IdPaziente"></asp:Parameter>
            ...
            <div id="rightSidebar" data-offset-top="65" data-spy="affix">
                <div class="custom-margin-right-sidebar">
                    <div class="row">
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal">
                                        <div class="col-sm-12">
                                            <div class="form-group form-group-sm">
                                                <asp:DropDownList ID="cmbFiltroTemporale" ClientIDMode="Static" AutoPostBack="true" runat="server" CssClass="form-control">
                                                    ...
                                                    <asp:ListItem Value="2" Text="Ultimo Anno" />
                                        ...
                                        <div id="FiltriCheckBoxList" visible="true" runat="server" class="checkbox checkboxlist">
                                            <div class="form-group form-group-sm">
                                                <asp:CheckBoxList CssClass="checkboxlist-custom-left-margin" ID="TipoRefertoCheckboxList" DataTextField="Descrizione" DataValueField="Id" AutoPostBack="true" RepeatLayout="flow" RepeatDirection="Horizontal" RepeatColumns="1" runat="server" DataSourceID="DataSourceLstTipiReferti">
                                                </asp:CheckBoxList>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group form-group-sm">
                                <asp:Button ID="btnExecutePrint" runat="server" CssClass="btn btn-default btn-block btn-sm" Text="Stampa Referti Selezionati" />
                            </div>
                            <div class=" form-group form-group-sm">
        ...
        <asp:ObjectDataSource ID="DataSourceLstTipiRefertiPerEpisodio" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetSelectedTipiReferto" TypeName="DwhClinico.Web.CustomDataSource.RefertiCercaPerNosologico">
            <SelectParameters>
                <asp:Parameter Name="listaReferti" Type="Object"></asp:Parameter>
            </SelectParameters>
        </asp:ObjectDataSource>
        <asp:ObjectDataSource ID="DataSourceLstTipiReferti" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetSelectedTipiReferto" TypeName="DwhClinico.Web.CustomDataSource.RefertiCercaPerIdPaziente">
            <SelectParameters>
                <asp:Parameter Name="IdPaziente" DbType="Guid" />
            </SelectParameters>
        </asp:ObjectDataSource>
        <asp:ObjectDataSource ID="DataSourceLstTipiPrescrizioni" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetSelectedTipiPrescrizione" TypeName="DwhClinico.Web.CustomDataSource.PrescrizioniCercaPerIdPaziente" />
    </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanelDettaglioEpisodio" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="small">
                                ...
                                <asp:ObjectDataSource ID="DataSourceEventiEpisodio" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="DwhClinico.Web.CustomDataSource.EventiEpisodioCercaPerId">
                                    <SelectParameters>
                                        <asp:Parameter Name="Token" Type="Object"></asp:Parameter>
    ...
    <script type="text/javascript">
        ...
        //Esegue il postback dell'objectDataSource dell'Episodio.
        ...
        function EnableButtonPatientSummary() {
            ...
            $.ajax({
                type: "POST",
                url: "RefertiListaPaziente.aspx/ShowPatientSummary",
                data: datajson,
