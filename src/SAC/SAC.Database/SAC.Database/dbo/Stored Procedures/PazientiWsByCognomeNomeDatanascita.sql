...
-- =============================================
CREATE PROCEDURE dbo.PazientiWsByCognomeNomeDatanascita
(
	@Identity varchar(64),
	@Cognome varchar(64),
	@Nome varchar(64),
...
BEGIN
	...
	BEGIN
		EXEC PazientiEventiAccessoNegato @Identity, 0, 'PazientiWsByCognomeNomeDatanascita', 'Utente non ha i permessi di lettura!'

		RAISERROR('Errore di controllo accessi durante PazientiWsByCognomeNomeDatanascita!', 16, 1)
		RETURN
	END
	--
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PazientiWsByCognomeNomeDatanascita] TO [DataAccessWs]
    AS [dbo];
