...
-- Modify date: 2014-10-27 SANDRO: Copiata da [WsOrdiniTestateListByIDSistemaRichiedente5]
...
-- =============================================
CREATE PROCEDURE [dbo].[WsOrdiniTestateList2ByIDSistemaRichiedente]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WsOrdiniTestateList2ByIDSistemaRichiedente] TO [DataAccessWs]
    AS [dbo];
