...
-- Modify date: 2014-10-27 SANDRO: Copiata da [WsOrdiniTestateListByIDSacPaziente5]
...
-- =============================================
CREATE PROCEDURE [dbo].[WsOrdiniTestateList2ByIDSacPaziente]
...
BEGIN
	...
	WHERE	T.PazienteIdSac = @IDSacPaziente
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WsOrdiniTestateList2ByIDSacPaziente] TO [DataAccessWs]
    AS [dbo];
