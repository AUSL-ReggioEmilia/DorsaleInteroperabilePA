...
Public Class UtentiDettaglio
	Inherits System.Web.UI.Page

	Private Const BACKPAGE As String = "ListaUtenti.aspx"
		...
		Try
			If Not Page.IsPostBack Then
				If String.IsNullOrEmpty(Request.QueryString("Id")) Then
					...
					LabelTitolo.Text = "Creazione Utente"
					LabelUtenteGruppi.Visible = False
					gvUtenteGruppi.Visible = False
					DirectCast(FormViewDettaglio.FindControl("chkAttivo"), CheckBox).Checked = True
					FormViewDettaglio.FindControl("txtNomeUtente").Focus()
			...
			Page.Form.DefaultButton = FormViewDettaglio.FindControl("butSalva").UniqueID
