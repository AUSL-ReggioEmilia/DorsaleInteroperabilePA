...
Public Class TranscodificaPrioritaDettaglio
    ...
    Private Const PAGE_LIST As String = "~/Transcodifiche/TranscodificaPrioritaLista.aspx"
    ...
    Private Sub odsMain_Selected(sender As Object, e As ObjectDataSourceStatusEventArgs) Handles odsMain.Selected
        Try
            ...
            Else
                ...
                '
                Dim odt As TranscodificheDataSet.TranscodificaPrioritaOttieniDataTable = CType(e.ReturnValue, TranscodificheDataSet.TranscodificaPrioritaOttieniDataTable)
