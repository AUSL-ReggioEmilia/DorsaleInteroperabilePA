...
-- Modify date: 2016-07-04: utilizzo della DataEvento per filtrare e ordinare
...
-- =============================================
CREATE PROCEDURE ws2.PrestazioniMatriceLabByNosologicoAzienda2
(
...
BEGIN
/*
	Sostituisce la dbo.Ws2PrestazioniMatriceLabByNosologicoAzienda2
	...
	----------------------------------------------------------------------------------------------------
	Differenze dalla Ws2.PrestazioniMatriceLabByNosologicoAzienda:
...
*/
	...
	WHERE	
			...
			--(NOT Prest.Risultato IS NULL or Prest.Risultato <> '' or NOT Prest.Commenti IS NULL or Prest.Commenti <> '') 
