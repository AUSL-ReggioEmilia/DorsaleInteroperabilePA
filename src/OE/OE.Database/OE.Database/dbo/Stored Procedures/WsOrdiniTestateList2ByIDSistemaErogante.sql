...
-- Modify date: 2014-10-27 SANDRO: Copiata da [WsOrdiniTestateListByIDSistemaErogante5]
...
-- =============================================
CREATE PROCEDURE [dbo].[WsOrdiniTestateList2ByIDSistemaErogante]
...
BEGIN
	...
	FROM dbo.WsOrdiniTestateList2 T
			INNER JOIN OrdiniErogatiTestate TE WITH(NOLOCK) ON TE.IDOrdineTestata = T.ID
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WsOrdiniTestateList2ByIDSistemaErogante] TO [DataAccessWs]
    AS [dbo];
