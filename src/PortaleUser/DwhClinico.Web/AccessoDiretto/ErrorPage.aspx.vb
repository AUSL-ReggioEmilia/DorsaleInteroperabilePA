...
'
'
Public Class AccessoDiretto_ErrorPage
    Inherits System.Web.UI.Page

    Private Const ERRORE_CODICE As String = "ACCESSO_DIRETTO_ERRORPAGE_ERRORE_CODICE"
    Private Const ERRORE_DESCRIZIONE As String = "ACCESSO_DIRETTO_ERRORE_DESCRIZIONE"
