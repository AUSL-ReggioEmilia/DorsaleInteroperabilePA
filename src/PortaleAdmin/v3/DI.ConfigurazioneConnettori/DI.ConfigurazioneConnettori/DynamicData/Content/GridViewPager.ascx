<%@ Control Language="VB" CodeBehind="GridViewPager.ascx.vb" Inherits="GridViewPager" %>
...
<span class="form-inline">
    ...
    <asp:TextBox ID="TextBoxPage" runat="server" Columns="5" AutoPostBack="true" ontextchanged="TextBoxPage_TextChanged" Width="20px" CssClass="" />
    of
...
<span class="form-inline pull-right">
    ...
    <asp:DropDownList ID="DropDownListPageSize" runat="server" AutoPostBack="true" CssClass="input-mini" onselectedindexchanged="DropDownListPageSize_SelectedIndexChanged">
