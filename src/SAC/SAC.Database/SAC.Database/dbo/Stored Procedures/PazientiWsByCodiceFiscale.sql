...
-- Description:	Restituisce i pazienti eseguendo un ricerca per codice fiscale
-- =============================================
CREATE PROCEDURE dbo.PazientiWsByCodiceFiscale
(
	@Identity varchar(64),
...
BEGIN
	...
	BEGIN
		EXEC PazientiEventiAccessoNegato @Identity, 0, 'PazientiCercaByCodiceFiscale', 'Utente non ha i permessi di lettura!'

		RAISERROR('Errore di controllo accessi durante PazientiCercaByCodiceFiscale!', 16, 1)
		RETURN
	END
	--
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PazientiWsByCodiceFiscale] TO [DataAccessWs]
    AS [dbo];
