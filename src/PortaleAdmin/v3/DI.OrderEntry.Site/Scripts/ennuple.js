...
function EditEnnupla(idEnnupla, inverso, idStato, descrizione, note, idGruppoUtenti, idGruppoPrestazioni, oraInizio, oraFine, lunedi, martedi, mercoledi, giovedi, venerdi, sabato, domenica, idUnitaOperativa, idSistemaRichiedente, idRegime, idPriorita) {
    ...
    var GruppiPrestazioniDropDownList = $("#" + _EnnuplaDetail_GruppiPrestazioniDropDownList);
    GruppiPrestazioniDropDownList.val(idGruppoPrestazioni);
