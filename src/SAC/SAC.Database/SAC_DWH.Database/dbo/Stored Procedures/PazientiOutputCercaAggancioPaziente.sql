...
(
 ...
 BEGIN 
	...
	BEGIN
		...
		BEGIN TRY
			...
			INSERT INTO @PazienteResult (Id , Provenienza , IdProvenienza 
			 ...
			 EXECUTE [dbo].[SAC_PazientiOutputCercaAggancioPaziente]
	...
	END ELSE BEGIN
		...
		SET @ErrMsg = 'SACConnDwh: Errore durante impersonificazione utente ' + @LoginToSAC + ' durante PazientiOutputCercaAggancioPaziente!'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PazientiOutputCercaAggancioPaziente] TO [ExecuteDwh]
    AS [dbo];
