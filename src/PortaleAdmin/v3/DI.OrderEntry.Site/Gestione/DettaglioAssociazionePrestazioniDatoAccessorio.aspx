<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SitePopup.Master" CodeBehind="DettaglioAssociazionePrestazioniDatoAccessorio.aspx.vb" Inherits=".DettaglioAssociazionePrestazioniDatoAccessorio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="OrderEntryContentPlaceHolder" runat="server">
    ...
    <asp:FormView runat="server" Style="width: 100%;" DefaultMode="Edit" ID="fvPrestazioniDatoAccessori" DataSourceID="odsPrestazioniDatoAccessori" DataKeyNames="Id">
        <EditItemTemplate>
            <fieldset>
                <legend>
                    <asp:CheckBox Checked='<%# Bind("Eredita") %>' TextAlign="Right" AutoPostBack="true" ID="EreditaCheckBox"
                        OnCheckedChanged="chkEreditaCheckedChanged" Text="Eredita da Dato Accessorio" runat="server" />
                </legend>
            ...
            <div style="margin-top: 40px; text-align: right">
                <asp:Button runat="server" Text="Conferma" CssClass="asp_button" CausesValidation="true" CommandName="Update" ID="UpdateButton"  />&nbsp;
    ...
    <asp:ObjectDataSource ID="odsPrestazioniDatoAccessori" runat="server" OldValuesParameterFormatString="{0}" SelectMethod="GetData" TypeName="DI.OrderEntry.Admin.Data.PrestazioniTableAdapters.UiPrestazioniDatiAccessoriSelectTableAdapter" UpdateMethod="Update">
        <SelectParameters>
            ...
            <asp:QueryStringParameter QueryStringField="idPrestazione" DbType="Guid" Name="IdPrestazione"></asp:QueryStringParameter>
        </SelectParameters>
        <UpdateParameters>
