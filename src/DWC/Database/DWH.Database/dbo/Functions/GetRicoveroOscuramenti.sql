...
-- Modify date: 2017-10-16 Ettore: Utilizzo della nuova TABLE FUNCTION generale per gli oscuramenti
...
-- =============================================
CREATE FUNCTION [dbo].[GetRicoveroOscuramenti]
(
...
AS
	...
	FROM [dbo].[OttieniRicoveroOscuramenti] (
								   NULL
								  ,'Massivi'
								  ,'DWH'
								  ,@AziendaErogante
