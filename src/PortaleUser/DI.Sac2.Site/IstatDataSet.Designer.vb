...
Namespace DI.Sac.User.Data.IstatDataSetTableAdapters
    ...
    Partial Public Class IstatAslTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As IstatDataSet.IstatAslDataTable, ByVal Codice As String, ByVal CodiceComune As String) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal Codice As String, ByVal CodiceComune As String) As IstatDataSet.IstatAslDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Codice Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(1).Value = Global.System.DBNull.Value
            Else
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(2).Value = CType(CodiceComune,String)
            End If
            Dim dataTable As IstatDataSet.IstatAslDataTable = New IstatDataSet.IstatAslDataTable()
