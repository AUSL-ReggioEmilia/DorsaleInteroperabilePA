...
-- Description:	Restituisce la lista delle note anamnestiche di un paziente ricercando per Anagrafica e IdAnagrafica su un intervallo di date
-- =============================================
CREATE PROCEDURE [ws3].[NoteAnamnesticheByPazienteRiferimenti]
(
...
BEGIN 
/*
	Restituisce note anamnestiche associate al'intera catena di fusione
*/
	SET NOCOUNT ON
	--
