...
-- Create date: 2016-07-14 - Copiata da [dbo].[GetEnnuple]
--								Rimosso parametro non usato @idSistemaErogante
--								Aggiunto parametro @dataoraRichiesta
--
-- Description:	Ritorna la lista delle prestazioni e profili richiedibili dall'utente
--					Dovra sostituire [dbo].[GetEnnuple]
-- =============================================
CREATE FUNCTION [dbo].[GetEnnuple2]
(
  @Utente VARCHAR (64)
