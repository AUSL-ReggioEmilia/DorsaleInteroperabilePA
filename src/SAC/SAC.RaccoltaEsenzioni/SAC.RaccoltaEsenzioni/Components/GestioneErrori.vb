...
Module GestioneErrori
    ...
    Public Function TrapError(exception As Exception) As String
        ...
        '
        ' MODIFICA ETTORE 2019-10-28: Eliminazione errore ThreadAbortException
        '
        ...
        '
        dicProp.Add("NomePortale", SAC.RaccoltaEsenzioni.CustomInitializer.Telemetry.MyTelemetryInitializer.RoleName)
        ...
        Else
            ...
            If exception.InnerException IsNot Nothing Then
                ...
                ElseIf TypeOf exception.InnerException Is SqlClient.SqlException Then
                    ...
                    ' Eccezione di tipo Sql
                    '
                    friendlyDetails = GetSqlExceptionError(exception.InnerException)
                Else
                    '
