...
CREATE PROCEDURE [dbo].[PazientiWsById]
(
	@Identity varchar(64),
	@Id uniqueidentifier
)
...
*/
	...
	BEGIN
		EXEC PazientiEventiAccessoNegato @Identity, 0, 'PazientiCercaById', 'Utente non ha i permessi di lettura!'

		RAISERROR('Errore di controllo accessi durante PazientiCercaById!', 16, 1)
		RETURN
	END
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PazientiWsById] TO [DataAccessWs]
    AS [dbo];
