...
-- Modify date: 2014-10-27 SANDRO: Copiata da [WsOrdiniTestateListByDataRichiesta2]
...
-- =============================================
CREATE PROCEDURE [dbo].[WsOrdiniTestateList2ByDataRichiesta]
...
BEGIN
	...
	WHERE 	(T.DataRichiesta >= @DataRichiestaInizio
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WsOrdiniTestateList2ByDataRichiesta] TO [DataAccessWs]
    AS [dbo];
