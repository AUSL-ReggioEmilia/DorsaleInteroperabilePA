<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="UtentePazienteDettaglio.aspx.vb"
	Inherits="DI.Sac.Admin.UtentePazienteDettaglio" %>

<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
	<asp:Label ID="LabelError" runat="server" CssClass="Error" EnableViewState="False" Visible="False" />
	<asp:Label ID="LabelTitolo" runat="server" CssClass="Title" EnableViewState="False" Text="Permessi Utente per il Servizio Pazienti" />
			...
			<table class="table_dettagli">
				...
				<tr>
					<td class="Td-Text">
						...
						<asp:RequiredFieldValidator ID="RequiredLivelloAttendibilita" runat="server" ControlToValidate="txtLivelloAttendibilita"
	...
	<asp:ObjectDataSource ID="MainObjectDataSource" runat="server" SelectMethod="GetData" TypeName="DI.Sac.Admin.Data.UtentiDataSetTableAdapters.UtentiPazientiTableAdapter"
